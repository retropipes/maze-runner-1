...
public class RandomInvisibleOneShotTeleporter extends RandomInvisibleTeleporter {
    // Serialization
    private static final long serialVersionUID = 108L;

    // Constructors
    public RandomInvisibleOneShotTeleporter() {
	super();
    }

    public RandomInvisibleOneShotTeleporter(final int newRandomRangeY, final int newRandomRangeX) {
