...
public class OneShotTeleporter extends AbstractTeleporter {
    // Serialization
    private static final long serialVersionUID = 203L;

    // Constructors
    public OneShotTeleporter() {
	super("OneShotTeleporter", "OneShotTeleporter", 0, 0, 0, 0);
    }

    public OneShotTeleporter(final int destinationRow, final int destinationColumn, final int destinationFloor,
	    final int destinationLevel) {
	super("OneShotTeleporter", "OneShotTeleporter", destinationRow, destinationColumn, destinationFloor,
		destinationLevel);
    }

    public OneShotTeleporter(final String gameAppearance, final String editorAppearance, final int destinationRow,
	...
	final MazeObject mo = MazeMaker.editTeleporterDestination(MazeMaker.TELEPORTER_TYPE_ONESHOT);
	return mo;
    }
}