...
public class RandomTeleporter extends AbstractTeleporter {
    ...
    public RandomTeleporter(final int newRandomRangeY, final int newRandomRangeX) {
	super("RandomTeleporter", "RandomTeleporter", 0, 0, 0, 0);
    ...
    public RandomTeleporter(final String gameAppearance, final String editorAppearance, final int newRandomRangeY,
	...
	final MazeObject mo = MazeMaker.editTeleporterDestination(MazeMaker.TELEPORTER_TYPE_RANDOM);
	return mo;
    }

    @Override
    public boolean equals(final Object obj) {
	final RandomTeleporter mgt = (RandomTeleporter) obj;
