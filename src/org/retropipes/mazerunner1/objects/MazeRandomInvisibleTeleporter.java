...
import org.retropipes.mazerunner1.objects.abc.MazeGenericInvisibleTeleporter;

public class MazeRandomInvisibleTeleporter extends MazeGenericInvisibleTeleporter {
    // Fields
    ...
    public MazeRandomInvisibleTeleporter(final int newRandomRangeY, final int newRandomRangeX) {
	super("Ground", "RandomInvisibleTeleporter", 0, 0, 0, 0);
    ...
    public MazeRandomInvisibleTeleporter(final String gameAppearance, final String editorAppearance,
	    final int newRandomRangeY, final int newRandomRangeX) {
	...
	if (super.equals(mgt) && this.randomRangeX == mgt.randomRangeX && this.randomRangeY == mgt.randomRangeY) {
	    return true;
	} else {
	    return false;
	}
	...
	final MazeObject mo = MazeMaker.editTeleporterDestination(MazeMaker.TELEPORTER_TYPE_RANDOM_INVISIBLE);
	return mo;
    }
}