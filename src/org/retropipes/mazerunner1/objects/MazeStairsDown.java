...
public class MazeStairsDown extends MazeGenericTeleporter {
    ...
    public MazeStairsDown(final String gameAppearance, final String editorAppearance) {
	super(gameAppearance, editorAppearance, 0, 0, 0, 0);
    }

    // For derived classes only
    protected MazeStairsDown(final String gameAppearance, final String editorAppearance,
