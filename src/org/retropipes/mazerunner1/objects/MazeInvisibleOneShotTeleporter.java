...
public class MazeInvisibleOneShotTeleporter extends MazeGenericInvisibleTeleporter {
    // Serialization
    ...
    public MazeInvisibleOneShotTeleporter(final int destinationRow, final int destinationColumn,
    ...
    public MazeInvisibleOneShotTeleporter(final String gameAppearance, final String editorAppearance,
	...
	final MazeObject mo = MazeMaker.editTeleporterDestination(MazeMaker.TELEPORTER_TYPE_INVISIBLE_ONESHOT);
	return mo;
    }
}