...
public class RandomInvisibleTeleporter extends AbstractInvisibleTeleporter {
    ...
    // Constructors
    public RandomInvisibleTeleporter() {
    ...
    public RandomInvisibleTeleporter(final int newRandomRangeY, final int newRandomRangeX) {
	super("Ground", "RandomInvisibleTeleporter", 0, 0, 0, 0);
    ...
    public RandomInvisibleTeleporter(final String gameAppearance, final String editorAppearance,
	...
	final RandomInvisibleTeleporter mgt = (RandomInvisibleTeleporter) obj;
