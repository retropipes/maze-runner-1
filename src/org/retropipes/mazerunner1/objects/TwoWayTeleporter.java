...
public class TwoWayTeleporter extends AbstractTeleporter {
    // Serialization
    private static final long serialVersionUID = 8021L;

    public TwoWayTeleporter() {
	super("TwoWayTeleporter", "TwoWayTeleporter", 0, 0, 0, 0);
    }

    public TwoWayTeleporter(final int destRow, final int destCol, final int destFloor, final int destLevel) {
	super("TwoWayTeleporter", "TwoWayTeleporter", destRow, destCol, destFloor, destLevel);
    }
	...
	final MazeObject mo = MazeMaker.editTeleporterDestination(MazeMaker.TELEPORTER_TYPE_TWOWAY);
	return mo;
    }
