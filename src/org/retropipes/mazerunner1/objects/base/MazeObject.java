...
public abstract class MazeObject implements Scriptable, Serializable {
    ...
    // Constructors
    public MazeObject(final boolean isSolid, final String newGameAppearance, final String newEditorAppearance) {
	...
	this.gameAppearance = ImageSetManager.getImage(MazeObject.set, MazeObject.size, newGameAppearance);
	this.editorAppearance = ImageSetManager.getImage(MazeObject.set, MazeObject.size, newEditorAppearance);
    ...
    public MazeObject(final boolean isSolidXN, final boolean isSolidXS, final boolean isSolidXE,
	    ...
	    final boolean isSolidIW, final String newGameAppearance, final String newEditorAppearance) {
    ...
    public MazeObject(final boolean isSolidXN, final boolean isSolidXS, final boolean isSolidXE,
	    final boolean isSolidXW, final boolean isSolidIN, final boolean isSolidIS, final boolean isSolidIE,
	    final boolean isSolidIW, final String newGameAppearance, final String newEditorAppearance,
	    final boolean pushable, final boolean doesAcceptPushInto, final boolean doesAcceptPushOut,
	    final boolean pullable, final boolean doesAcceptPullInto, final boolean doesAcceptPullOut,
    ...
    public MazeObject(final boolean isSolidXN, final boolean isSolidXS, final boolean isSolidXE,
	    ...
	    final boolean pushable, final boolean doesAcceptPushInto, final boolean doesAcceptPushOut,
	    final boolean pullable, final boolean doesAcceptPullInto, final boolean doesAcceptPullOut,
	    final boolean hasFriction, final boolean isUsable, final int newUses, final boolean isDestroyable,
    ...
    public MazeObject(final boolean isSolid, final String newGameAppearance, final String newEditorAppearance,
	    final boolean isUsable, final int newUses, final boolean canBeInventoried) {
	this.solidXN = isSolid;
	this.solidXS = isSolid;
	this.solidXE = isSolid;
	this.solidXW = isSolid;
	...
	return this.solidXN && this.solidXS && this.solidXE && this.solidXW && this.solidIN && this.solidIS
		&& this.solidIE && this.solidIW;
    }
	...
	this.gameAppearance = ImageSetManager.getImage(MazeObject.set, MazeObject.size, this.storedGameAppearance);
	this.editorAppearance = ImageSetManager.getImage(MazeObject.set, MazeObject.size, this.storedEditorAppearance);
    }
    ...
    @Override
    public void pushAction(final Inventory inv, final MazeObject mo, final int x, final int y, final int pushX,
	    final int pushY) {
	// Do nothing
    }
    ...
    @Override
    public void pullAction(final Inventory inv, final MazeObject mo, final int x, final int y, final int pullX,
	    final int pullY) {
	// Do nothing
    }
     ...
     * @return
     */
    public ImageIcon gameRenderHook(final int x, final int y, final int z, final int w) {
	return this.gameAppearance;
    }
	...
	result = prime * result + (this.storedEditorAppearance == null ? 0 : this.storedEditorAppearance.hashCode());
	result = prime * result + (this.storedGameAppearance == null ? 0 : this.storedGameAppearance.hashCode());
	...
	} else if (!this.storedEditorAppearance.equals(other.storedEditorAppearance)) {
	    return false;
	}
	...
	} else if (!this.storedGameAppearance.equals(other.storedGameAppearance)) {
	    return false;
	}
