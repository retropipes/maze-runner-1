...
public abstract class AbstractInvisibleTeleporter extends AbstractTeleporter {
    // Serialization
    private static final long serialVersionUID = 7556L;

    // Constructors
    protected AbstractInvisibleTeleporter(final String gameAppearance, final String editorAppearance,
