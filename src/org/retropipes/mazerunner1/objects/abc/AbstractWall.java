...
public abstract class AbstractWall extends MazeObject {
    ...
    // Constructors
    protected AbstractWall(final String gameAppearance, final String editorAppearance) {
	super(true, gameAppearance, editorAppearance);
    }

    protected AbstractWall(final boolean isSolidXN, final boolean isSolidXS, final boolean isSolidXE,
    ...
    protected AbstractWall(final String gameAppearance, final String editorAppearance, final boolean isDestroyable,
