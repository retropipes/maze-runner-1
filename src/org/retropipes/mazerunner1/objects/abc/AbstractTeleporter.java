...
public abstract class AbstractTeleporter extends MazeObject {
    // Fields
    private int destRow;
    private int destCol;
	...
	final AbstractTeleporter mgt = (AbstractTeleporter) obj;
	if (super.equals(mgt) && this.destRow == mgt.destRow && this.destCol == mgt.destCol
		&& this.destFloor == mgt.destFloor && this.destLevel == mgt.destLevel) {
	    return true;
	} else {
	    return false;
	}
