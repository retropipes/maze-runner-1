...
public abstract class MazeGenericWall extends MazeObject {
    ...
    // Constructors
    protected MazeGenericWall(final String gameAppearance, final String editorAppearance) {
	super(true, gameAppearance, editorAppearance);
    }

    protected MazeGenericWall(final boolean isSolidXN, final boolean isSolidXS, final boolean isSolidXE,
	    final boolean isSolidXW, final boolean isSolidIN, final boolean isSolidIS, final boolean isSolidIE,
	    final boolean isSolidIW, final String gameAppearance, final String editorAppearance) {
	super(isSolidXN, isSolidXS, isSolidXE, isSolidXW, isSolidIN, isSolidIS, isSolidIE, isSolidIW, gameAppearance,
		editorAppearance);
    }

    protected MazeGenericWall(final String gameAppearance, final String editorAppearance, final boolean isDestroyable,
	    final boolean doesChainReact) {
	super(true, true, true, true, true, true, true, true, gameAppearance, editorAppearance, false, false, false,
		false, false, false, true, false, 0, isDestroyable, doesChainReact);
    }
