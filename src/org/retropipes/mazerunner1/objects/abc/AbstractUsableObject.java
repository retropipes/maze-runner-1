...
public abstract class AbstractUsableObject extends MazeObject {
    // Serialization
    private static final long serialVersionUID = 8050L;

    // Constructors
    protected AbstractUsableObject(final String gameAppearance, final String editorAppearance, final int newUses) {
