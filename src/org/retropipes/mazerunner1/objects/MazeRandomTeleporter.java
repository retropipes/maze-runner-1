...
public class MazeRandomTeleporter extends MazeGenericTeleporter {
    ...
    public MazeRandomTeleporter(final int newRandomRangeY, final int newRandomRangeX) {
	super("RandomTeleporter", "RandomTeleporter", 0, 0, 0, 0);
    ...
    public MazeRandomTeleporter(final String gameAppearance, final String editorAppearance, final int newRandomRangeY,
