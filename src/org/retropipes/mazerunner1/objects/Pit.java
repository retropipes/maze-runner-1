...
public class Pit extends StairsDown {
	...
	if (!app.isFloorBelow() && app.getMessageEnabled(MazeRunner.MESSAGE_CANNOT_GO_THAT_WAY)) {
	...
	if (pushed.isPushable()) {
	    final MazeRunner app = MazeRunner.getApplication();
	    final PushableBlock pushedInto = (PushableBlock) pushed;
	    app.updatePushedIntoPositionAbsolute(x, y, z - 1, w, x, y, z, w, pushedInto, this);
	}
    }
