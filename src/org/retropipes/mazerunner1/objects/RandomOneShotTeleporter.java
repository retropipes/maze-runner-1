...
public class RandomOneShotTeleporter extends RandomTeleporter {
    // Serialization
    private static final long serialVersionUID = 105L;

    // Constructors
    public RandomOneShotTeleporter() {
	super();
    }

    public RandomOneShotTeleporter(final int newRandomRangeY, final int newRandomRangeX) {
	super("RandomOneShotTeleporter", "RandomOneShotTeleporter", newRandomRangeY, newRandomRangeX);
    }
	...
	final MazeObject mo = MazeMaker.editTeleporterDestination(MazeMaker.TELEPORTER_TYPE_RANDOM_ONESHOT);
	return mo;
    }
}