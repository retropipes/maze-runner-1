...
public class MazeOneShotTeleporter extends MazeGenericTeleporter {
    ...
    public MazeOneShotTeleporter(final int destinationRow, final int destinationColumn, final int destinationFloor,
	    final int destinationLevel) {
	super("OneShotTeleporter", "OneShotTeleporter", destinationRow, destinationColumn, destinationFloor,
		destinationLevel);
    }

    public MazeOneShotTeleporter(final String gameAppearance, final String editorAppearance, final int destinationRow,
