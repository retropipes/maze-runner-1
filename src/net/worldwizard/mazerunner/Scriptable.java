...
public interface Scriptable {
    ...
    boolean isConditionallyDirectionallySolid(boolean ie, int dirX, int dirY, Inventory inv);

    MazeObject editorHook();

    void playSound();

    void pushAction(Inventory inv, MazeObject mo, int x, int y, int pushX, int pushY);

    void pushIntoAction(Inventory inv, MazeObject pushed, int x, int y, int z, int w);

    void pushOutAction(Inventory inv);

    void pullAction(Inventory inv, MazeObject mo, int x, int y, int pullX, int pullY);
