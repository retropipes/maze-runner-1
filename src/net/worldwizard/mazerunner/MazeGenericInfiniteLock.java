...
public abstract class MazeGenericInfiniteLock extends MazeObject {
    ...
    protected MazeGenericInfiniteLock(final String gameAppearance, final String editorAppearance,
	    final MazeGenericInfiniteKey mgk) {
	super(true, gameAppearance, editorAppearance);
	this.key = mgk;
    }

    protected MazeGenericInfiniteLock(final String gameAppearance, final String editorAppearance,
	    final MazeGenericInfiniteKey mgk, final boolean doesAcceptPushInto) {
